...
1. Run `setup_holon.sh` to initialise the directory structure
2. Run `python orchestrate_intent.py holon/ledger holon/scripts/intent_bootstrap_cli.json repo/` to start the first
   intent
